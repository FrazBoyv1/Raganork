...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '917994929427@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '917994929427' : process.env.ALL_NUMBER,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'FrAzBoY¹¹;ʀᴀɢᷨᴀͦɴͭᴏʀᴋ;https://i.imgur.com/63BrtyT.jpeg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'FrazBoy¹¹' : process.env.OWNER_NAME,
    ...
    SUPPORT: process.env.ASENA === undefined ? '917994929427-1632403322,120363038867058369' : process.env.ASENA,
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://c.tenor.com/G9Bu13ZlhVkAAAPo/dancing-funny-dance.mp4' : process.env.GIF_WEL,
    SLINK: process.env.IG === undefined ? 'instagram.com/itz_me_arun_._' : process.env.IG,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/63BrtyT.jpeg' : process.env.ALL_IMG,
    created_by_souravkl11: process.env.ALL_IMG2 === undefined ? 'https://i.imgur.com/63BrtyT.jpeg' : process.env.ALL_IMG2,
    find_key: process.env.FIND_KEY === undefined ? '' : process.env.FIND_KEY,
    SKDL: process.env.DIALOGUE === undefined ? '❤️‍🔥 𝗭𝗶𝗮𝗠𝘄𝗼𝗹𝗶𝘀𝗮𝗺 𝗡𝗘𝗩𝗘𝗥 𝗘𝗡𝗗𝗦 ❤️‍🔥' : process.env.DIALOGUE,
    BLOCKMSG: process.env.BLOCK_MESSAGE === undefined ? 'default' : process.env.BLOCK_MESSAGE,
    UNBLOCKMSG: process.env.UNBLOCK_MESSAGE === undefined ? 'default' : process.env.UNBLOCK_MESSAGE,
    SOURAV: process.env.SK_BLOCK === undefined ? 'false' : process.env.SK_BLOCK,
    SOURAVKL11: process.env.STICKER_DATA === undefined ? '𝗙𝗿𝗮𝘇ᵇᵒʸ|ʀᴀɢᷨᴀͦɴͭᴏʀᴋ' : process.env.STICKER_DATA,
    ...
    YAK: process.env.YAK === undefined ? '917994929427' : process.env.YAK,
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/FxmjVYxSXPl0C7jfD26tRF' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUDO: process.env.SUDO === undefined ? '917994929427,0' : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT2: "900000000000",
    SUPPORT3: "900000000001"
};
